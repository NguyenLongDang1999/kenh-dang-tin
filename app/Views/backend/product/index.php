...
<script>
    ...
    var url_delete_item = "<?= route_to('admin.product.multiDestroy') ?>";
    var url_status_item = "<?= route_to('admin.product.multiStatus') ?>";
    var click_mode = 0;
    ...
    if (productTable.length) {
        var oTable = productTable.DataTable({
            ...
            "sAjaxSource": "<?= route_to('admin.product.getList') ?>",
            "bDeferRender": true,
            "bFilter": false,
            "bDestroy": true,
    ...
    $(document).ready(function() {
        ...
        $('#btn-reset').on('click', function() {
            ...
            $('#frmSearch select[name="search[featured]"]').val('').trigger("change");
            $('#frmSearch select[name="search[cat_id]"]').val('').trigger("change");
            oTable.draw();
        });
    });
        ...
        <div class="col-12">
            ...
            <div class="mb-2">
                <div class="mb-sm-0 mb-25">
                    <a href="<?= route_to('admin.product.create') ?>" class="btn btn-icon btn-outline-primary">
                        <i data-feather="plus"></i>
                        <span>Thêm Mới</span>
                    </a>

                    <a href="<?= route_to('admin.product.recycle') ?>" class="btn btn-icon btn-outline-danger">
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title text-capitalize">Quản lý sản phẩm</h4>
                </div>
                <div class="card-body mt-2">
                    <?= form_open(route_to('admin.product.getList'), ['id' => 'frmSearch', 'method' => 'GET', 'onsubmit' => 'return false;']) ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        <?= form_label('Tên sản phẩm', 'search[name]', ['class' => 'form-label text-capitalize']) ?>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        <?= form_label('Danh mục', 'search[cat_id]', ['class' => 'form-label text-capitalize']) ?>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        <?= form_label('Nổi bật', 'search[featured]', ['class' => 'form-label text-capitalize']) ?>
                                        <?= form_dropdown('search[featured]', getOptionSelectStatus(), '', ['class' => 'form-control select2-custom', 'data-minimum-results-for-search' => 'Infinity']) ?>
                                    </div>
                                </div>
                            </div>
