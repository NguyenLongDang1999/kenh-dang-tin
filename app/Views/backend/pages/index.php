...
<script>
    ...
    var url_delete_item = "<?= route_to('admin.pages.multiDestroy') ?>";
        ...
        <div class="col-12">
            ...
            <div class="mb-2 d-flex justify-content-sm-between justify-content-center flex-wrap">
                <div class="mb-sm-0 mb-25">
                    <a href="<?= route_to('admin.pages.create') ?>" class="btn btn-icon btn-outline-primary">
                        <i data-feather="plus"></i>
                        <span>Thêm Mới</span>
                    </a>

                    <a href="<?= route_to('admin.pages.recycle') ?>" class="btn btn-icon btn-outline-danger">
                ...
                <div class="mt-sm-0 mt-25">
                    <a href="<?= route_to('admin.pages.reorder') ?>" class="btn btn-icon btn-outline-info">
                        <i data-feather='shuffle'></i>
                        <span>Sắp Xếp Trang</span>
                    </a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title text-capitalize">Quản lý trang</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        <?= form_label('Tiêu đề trang', 'search[name]', ['class' => 'form-label text-capitalize']) ?>
