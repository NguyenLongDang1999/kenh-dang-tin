    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            <li class="nav-item d-none d-sm-block">
                <a class="btn btn-flat-secondary btn-doc-header waves-effect" href="<?= route_to('user.home.index') ?>" target="_blank">
                    <i class="me-25" data-feather="layout"></i> Live Preview</a>
            </li>
